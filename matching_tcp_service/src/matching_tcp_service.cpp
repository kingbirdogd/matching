...
{
  fprintf(stderr, "%lu Received ORDER. timestamp:%llu request_id:%llu client_order_id:%llu action:%d order_id:%llu\n",
          current(), o.timestamp_epoch_ms, o.request_id, o.client_order_id, (int)o.order_action, o.order_id);
...
{
  fprintf(stderr, "%lu Sending  REPLY. timestamp:%llu request_id:%llu client_order_id:%llu action:%d order_id:%llu\n",
          current(), o.timestamp_epoch_ms, o.request_id, o.client_order_id, (int)o.order_action, o.order_id);
  s_.send(o);
  fprintf(stderr, "%lu Sent     REPLY. timestamp:%llu request_id:%llu client_order_id:%llu action:%d order_id:%llu\n",
          current(), o.timestamp_epoch_ms, o.request_id, o.client_order_id, (int)o.order_action, o.order_id);
}

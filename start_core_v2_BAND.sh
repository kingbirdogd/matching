...
# Matching server
${CORE_LOCATION}/test_tcp_matching_server ${NODE_ID} 100000000 34671 34672 34673 34674 34675 34676 1 0.001 1 0.001 0.00005 1 2 2>&1 | tee -a ${LOG_LOCATION}/matching_server.err.log & # >> ${LOG_LOCATION}/matching_server.out.log &
sleep 2
...
# MD Orderbook Server
PUB_TIME_MS=50
#CRV_USD_QP=10001021200925
#${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${CRV_USD_QP}   -F persistent://CF-V2/ME-WS/MD-DIFF-${CRV_USD_QP}   -G 7081 -X 35671 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar1.out.log 2>> /dev/null & # ${LOG_LOCATION}/proxy_md_pulsar1.err.log &
#sleep 1
CRV_USD_SWAP=14001011000000
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${CRV_USD_SWAP} -F persistent://CF-V2/ME-WS/MD-DIFF-${CRV_USD_SWAP} -G 7082 -X 35672 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar2.out.log 2>> ${LOG_LOCATION}/proxy_md_pulsar2.err.log &
sleep 1
#CRV_USD_SPR=10001051200925
#${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${CRV_USD_SPR}  -F persistent://CF-V2/ME-WS/MD-DIFF-${CRV_USD_SPR}  -G 7083 -X 35673 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar3.out.log 2>> /dev/null & # ${LOG_LOCATION}/proxy_md_pulsar3.err.log &
#sleep 1
CRV_USD=14001000000000
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${CRV_USD}      -F persistent://CF-V2/ME-WS/MD-DIFF-${CRV_USD}      -G 7084 -X 35674 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar4.out.log 2>> ${LOG_LOCATION}/proxy_md_pulsar4.err.log &
sleep 1
CRV_USD_REPO=14001031000000
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${CRV_USD_REPO} -F persistent://CF-V2/ME-WS/MD-DIFF-${CRV_USD_REPO} -G 7085 -X 35675 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar5.out.log 2>> ${LOG_LOCATION}/proxy_md_pulsar5.err.log &
sleep 1
...
# Pulsar Proxy
#${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34671 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${CRV_USD_QP}   persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${CRV_USD_QP}   ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy1.out.log 2>> ${LOG_LOCATION}/pulsar_proxy1.err.log &
#sleep 1
${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34672 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${CRV_USD_SWAP} persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${CRV_USD_SWAP} ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy2.out.log 2>> ${LOG_LOCATION}/pulsar_proxy2.err.log &
sleep 1
#${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34673 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${CRV_USD_SPR}  persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${CRV_USD_SPR}  ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy3.out.log 2>> ${LOG_LOCATION}/pulsar_proxy3.err.log &
#sleep 1
${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34674 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${CRV_USD}      persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${CRV_USD}      ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy4.out.log 2>> ${LOG_LOCATION}/pulsar_proxy4.err.log &
sleep 1
${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34675 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${CRV_USD_REPO} persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${CRV_USD_REPO} ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy5.out.log 2>> ${LOG_LOCATION}/pulsar_proxy5.err.log &
sleep 1

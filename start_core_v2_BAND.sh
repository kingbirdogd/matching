...
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${CRV_USD_SWAP} -F persistent://CF-V2/ME-WS/MD-DIFF-${CRV_USD_SWAP} -G 7082 -X 35672 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar2.out.log 2>> /dev/null & # ${LOG_LOCATION}/proxy_md_pulsar2.err.log &
sleep 1
...
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${CRV_USD}      -F persistent://CF-V2/ME-WS/MD-DIFF-${CRV_USD}      -G 7084 -X 35674 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar4.out.log 2>> /dev/null & # ${LOG_LOCATION}/proxy_md_pulsar4.err.log &
sleep 1
CRV_USD_REPO=14001031000000
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${CRV_USD_REPO} -F persistent://CF-V2/ME-WS/MD-DIFF-${CRV_USD_REPO} -G 7085 -X 35675 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar5.out.log 2>> /dev/null & # ${LOG_LOCATION}/proxy_md_pulsar5.err.log &
sleep 1

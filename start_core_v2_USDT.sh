...
# Matching server
${CORE_LOCATION}/test_tcp_matching_server 100000000 34671 34672 34673 34674 34675 34676 1 0.0001 1 0.0001 0.00005 1 2 >> ${LOG_LOCATION}/matching_server.out.log 2>> ${LOG_LOCATION}/matching_server.err.log &
sleep 2
# MD Implied Server

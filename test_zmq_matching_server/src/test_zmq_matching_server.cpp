...
int main(int iArgc, char** pszArgv)
{
  ...
  if (4 != iArgc)
  {
	...
	{
    std::cout << "usage: test_zmq_matching_server <port1[1,65535]> <port2[1,65535]> <port3[1,65535]>" << std::endl;
		return -2;
	}
  ...
  matching_zmq_service s2(ctx, sPort2);
  matching_zmq_service s3(ctx, sPort3);

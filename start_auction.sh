...
$BASEDIR/auction_tcp_matching_client 127.0.0.1 $MARKETPORT $QTYFACTOR $PXFACTOR $ACCOUNTID $MARKETID $QTY $PX $SIDE $BUY_UPPER_BAND $SELL_LOWER_BAND 2>&1 >> `cat $BASEDIR/LOG_LOCATION`/auction.log

...
# Matching server
${CORE_LOCATION}/test_tcp_matching_server ${NODE_ID} 100000000 34671 34672 34673 34674 34675 34676 0.5 0.05 0.1 0.05 0.00005 0.5 2 >> ${LOG_LOCATION}/matching_server.out.log 2>> ${LOG_LOCATION}/matching_server.err.log &
sleep 2

## MD Implied Server
#${CORE_LOCATION}/test_md_tcp_server 100000000 127.0.0.1 34671 127.0.0.1 34673 127.0.0.1 34672 a_bid_b_bid   a_ask_b_ask   add_bid_implier      add_ask_implier      35671 127.0.0.1 0.5  0 >> ${LOG_LOCATION}/md_tcp1.out.log 2>> ${LOG_LOCATION}/md_tcp1.err.log &
#sleep 1
...
##sleep 1
#${CORE_LOCATION}/test_md_tcp_server 100000000 127.0.0.1 34674 127.0.0.1 34672 127.0.0.1 34675 a_bid_b_bid   a_ask_b_ask   repo_out_bid_implier repo_out_ask_implier 35674 127.0.0.1 0.05 0 >> ${LOG_LOCATION}/md_tcp4.out.log 2>> ${LOG_LOCATION}/md_tcp4.err.log &
#sleep 1
...
sleep 1
${CORE_LOCATION}/test_md_tcp_server 100000000 127.0.0.1 34672 35672 127.0.0.1 0.05 0 127.0.0.1 34671 127.0.0.1 34673 a_bid_b_ask   a_ask_b_bid   minus_bid_implier    minus_ask_implier >> ${LOG_LOCATION}/md_tcp2.out.log 2>> ${LOG_LOCATION}/md_tcp2.err.log &
sleep 1
#${CORE_LOCATION}/test_md_tcp_server 100000000 127.0.0.1 34673 35673 127.0.0.1 1   2 127.0.0.1 34671 127.0.0.1 34672 a_bid_b_ask   a_ask_b_bid   minus_bid_implier    minus_ask_implier >> ${LOG_LOCATION}/md_tcp3.out.log 2>> ${LOG_LOCATION}/md_tcp3.err.log &
#sleep 1
${CORE_LOCATION}/test_md_tcp_server 100000000 127.0.0.1 34674 35674 127.0.0.1 0.05 0 127.0.0.1 34672 127.0.0.1 34675 a_bid_b_bid   a_ask_b_ask   repo_out_bid_implier repo_out_ask_implier  >> ${LOG_LOCATION}/md_tcp4.out.log 2>> ${LOG_LOCATION}/md_tcp4.err.log &
sleep 1
...
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${BCH_USD_QP}   -F persistent://CF-V2/ME-WS/MD-DIFF-${BCH_USD_QP}   -X 35671 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar1.out.log 2>> ${LOG_LOCATION}/proxy_md_pulsar1.err.log &
sleep 1
BCH_USD_SWAP=5001011000000
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${BCH_USD_SWAP} -F persistent://CF-V2/ME-WS/MD-DIFF-${BCH_USD_SWAP} -X 35672 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar2.out.log 2>> ${LOG_LOCATION}/proxy_md_pulsar2.err.log &
sleep 1
#BCH_USD_SPR=
#${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${BCH_USD_SPR}  -F persistent://CF-V2/ME-WS/MD-DIFF-${BCH_USD_SPR} -X 35673 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar3.out.log & #2>> ${LOG_LOCATION}/proxy_md_pulsar3.err.log &
#sleep 1
BCH_USD=5001000000000
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${BCH_USD}      -F persistent://CF-V2/ME-WS/MD-DIFF-${BCH_USD}      -X 35674 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar4.out.log 2>> ${LOG_LOCATION}/proxy_md_pulsar4.err.log &
sleep 1
BCH_USD_REPO=5001031000000
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${BCH_USD_REPO} -F persistent://CF-V2/ME-WS/MD-DIFF-${BCH_USD_REPO} -X 35675 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar5.out.log 2>> ${LOG_LOCATION}/proxy_md_pulsar5.err.log &
sleep 1
BCHABC_USD_QP=11001021200925
${CORE_LOCATION}/proxy_md_pulsar -s ${CORE_LOCATION}/md.fbs -B $PUB_TIME_MS -R pulsar://${PLSR_URL} -E persistent://CF-V2/ME-WS/MD-SNAPSHOT-${BCHABC_USD_QP} -F persistent://CF-V2/ME-WS/MD-DIFF-${BCHABC_USD_QP} -X 35676 -v --oneQueue --skipAuth localhost >> ${LOG_LOCATION}/proxy_md_pulsar6.out.log 2>> ${LOG_LOCATION}/proxy_md_pulsar6.err.log &
sleep 1
...
sleep 1
#${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34673 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${BCH_USD_SPR}  persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${BCH_USD_SPR}  ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy3.out.log 2>> ${LOG_LOCATION}/pulsar_proxy3.err.log &
#sleep 1
${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34674 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${BCH_USD}       persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${BCH_USD}       ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy4.out.log 2>> ${LOG_LOCATION}/pulsar_proxy4.err.log &
sleep 1
${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34675 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${BCH_USD_REPO}  persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${BCH_USD_REPO}  ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy5.out.log 2>> ${LOG_LOCATION}/pulsar_proxy5.err.log &
sleep 1
${CORE_LOCATION}/pulsar_proxy 127.0.0.1 34676 pulsar://${PLSR_URL} persistent://CF-V2/PRETRADE-ME/ORDER-IN-${BCHABC_USD_QP} persistent://CF-V2/ME-POSTTRADE/ORDER-OUT-${BCHABC_USD_QP} ${CORE_LOCATION}/msg.fbs >> ${LOG_LOCATION}/pulsar_proxy6.out.log 2>> ${LOG_LOCATION}/pulsar_proxy6.err.log &
sleep 1

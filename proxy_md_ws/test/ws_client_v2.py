...
if __name__ == '__main__':
    ...
    payload_place_sell1  = {'side':'SELL', "price": 30, 'quantity':    5,'order_action':'NEW',  'method':'PlaceOrder', 'client_order_id': tonce};      tonce += 1;
    ...
    loop.create_task(test(HOST1, payload_place_sell1))
